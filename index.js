...
app.get('/', async (req, res) => {
  mongoRepository.pegarTodosOsProdutos(req.user).then((foundProds) => {
  res.render('index', { products: foundProds });
})
});
...
app.get('/prod/my-products', (req, res) => {
  console.log('GET - /prod/my-products')
  mongoRepository.getProdsByUser(req.user).then((foundProds) => {
    res.render('prod/my-products', { loggedUser: req.user, products: foundProds})
  })
})
